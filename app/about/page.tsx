...
const timeline = [
  { year: "2016", detail: "Founded in Auckland by three analysts from the public and finance sectors." },
        ...
        <div className="mt-12 flex flex-col divide-y divide-[#2B3B52] border-t border-[#2B3B52]">
          {timeline.map((item) => (
            <div key={item.year} className="flex flex-col gap-2 py-6 sm:flex-row sm:items-baseline sm:gap-8">
              <span className="w-24 shrink-0 font-[family-name:var(--font-archivo)] text-xl font-bold text-white">
                {item.year}
              </span>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { name: "Daniel Osei", role: "Head of Compliance Advisory" },
            ].map((person) => (
              <div key={person.name}>
